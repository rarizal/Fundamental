...
salary() {
    if (this.tipe == "full") {
        ...
        if (this.jam <= 6) {
            ...
            return (this.jam * gajifull) + ((this.jam - 6) * (gajifull - 25000));
        ...
        if (this.jam <= 6) {
            ...
            return (this.jam * gajipart) + ((this.jam - 6) * (gajipart - 20000));
...
class ShootingGame {
    ...
    start() {
        ...
        while (true) {
            ...
            console.log(`Player ${this.player1.name} shoots ${this.player2.name}`);
            this.player1.hit(this.player2.power);
            console.log(`Player ${this.player1.name} remaining health: ${this.player1.health}`);
            ...
            console.log(`Player ${this.player2.name} shoots ${this.player1.name}`);
            this.player2.hit(this.player1.power);
            console.log(`${this.player1.name} remaining health: ${this.player1.health}`);
